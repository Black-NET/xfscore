...
def setup():
    ...
    if not os.path.isdir('gitian.sigs-index-index'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xfs/gitian.sigs-index'])
    if not os.path.isdir('index-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xfs/index-detached-sigs'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('Index'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xfs/Index'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/xfs/Index', help='Specify the URL of the repository. Default is %(default)s')
