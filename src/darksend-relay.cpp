...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinXFSnodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinXFSnode = vinXFSnodeIn;
    vchSig = vchSigIn;
...
{
    CXFSnode* pmn = mnodeman.GetXFSnodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
