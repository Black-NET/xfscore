...
extern UniValue xfsnode(const UniValue& params, bool fHelp);
extern UniValue xfsnodelist(const UniValue& params, bool fHelp);
extern UniValue xfsnodebroadcast(const UniValue& params, bool fHelp);
