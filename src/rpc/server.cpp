...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "addressindex",       "getaddressbalance",      &getaddressbalance,      false },
        /* XFS features */
    { "index",               "xfsnode",                 &xfsnode,                  true  },
    { "index",               "insync",                &insync,                 true  },
    { "index",               "xfsnodelist",             &xfsnodelist,              true  },
    { "index",               "xfsnodebroadcast",        &xfsnodebroadcast,         true  },
...
{
    return "> xfs-cli " + methodname + " " + args + "\n";
}
