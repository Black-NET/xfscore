...
protected:
    ...
    virtual void UpdatedXFSnode(CXFSnode &xfsnode) {}
    ...
    virtual void NotifyXFSnodeList() {}
...
struct CMainSignals {
    ...
    /** Notifies listeners of change to a XFSnode entry */
    boost::signals2::signal<void (CXFSnode &)> UpdatedXFSnode;
    ...
    /** Notifies listeners of XFSnode list */
    boost::signals2::signal<void ()> NotifyXFSnodeList;
