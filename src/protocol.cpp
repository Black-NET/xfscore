...
//xfsnode
    ...
    const char *XFSNODEPAYMENTVOTE = "mnw";
    const char *XFSNODEPAYMENTBLOCK = "mnwb";
    const char *XFSNODEPAYMENTSYNC = "mnget";
...
const static std::string allNetMessageTypes[] = {
        ...
        NetMsgType::XFSNODEPAYMENTVOTE,
        NetMsgType::XFSNODEPAYMENTBLOCK,
        NetMsgType::XFSNODEPAYMENTSYNC,
        NetMsgType::SPORK,
...
const char* CInv::GetCommand() const
{
    ...
    switch (type)
    {
        ...
        case MSG_XFSNODE_PAYMENT_VOTE:    return NetMsgType::XFSNODEPAYMENTVOTE;
        case MSG_XFSNODE_PAYMENT_BLOCK:   return NetMsgType::XFSNODEPAYMENTBLOCK;
        case MSG_XFSNODE_ANNOUNCE:        return NetMsgType::MNANNOUNCE;
        case MSG_XFSNODE_PING:            return NetMsgType::MNPING;
        case MSG_DSTX:                  return NetMsgType::DSTX;
        case MSG_XFSNODE_VERIFY:          return NetMsgType::MNVERIFY;
        default: {
            return "error";
        }
    }
