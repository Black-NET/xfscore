...
UniValue apistatus(Type type, const UniValue& data, const UniValue& auth, bool fHelp)
{
    ...
    modules.push_back(Pair("XFSnode", xfsnodeSync.IsSynced()));
    ...
    UniValue xfsnode(UniValue::VOBJ);
    xfsnode.push_back(Pair("localCount", xfsnodeConfig.getCount()));
    xfsnode.push_back(Pair("totalCount", mnodeman.CountXFSnodes()));
    xfsnode.push_back(Pair("enabledCount", mnodeman.CountEnabled()));
    obj.push_back(Pair("XFSnode", xfsnode));
    ...
    obj.push_back(Pair("synced",        xfsnodeSync.GetBlockchainSynced()));
    obj.push_back(Pair("reindexing",    fReindex || !xfsnodeSync.GetBlockchainSynced()));
