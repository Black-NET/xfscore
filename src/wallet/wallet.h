...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find xfsnode outputs including locked ones (use with caution)
...
public:
    ...
    // xfsnode
    /// Get 5000 XFS output and keys which can be used for the XFSnode
    bool GetXFSnodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
