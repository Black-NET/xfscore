...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a XFS wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private Q_SLOTS:
    ...
    /** Switch directly to XFS history tab */
    void gotoBitcoinHistoryTab();
    /** Switch to xfsnode page */
    void gotoXFSnodePage();
