...
#endif
    xfsnodeListPage = new XFSnodeList(platformStyle);
...
void WalletView::setupTransactionPage()
{
    ...
    // Create export panel for XFS transactions
    ...
    if (isElysiumEnabled()) {
        ...
        transactionTabs->addTab(indexTransactionsView, tr("XFS"));
...
void WalletView::setupSendCoinPage()
{
    ...
    if (isElysiumEnabled()) {
        ...
        sendCoinsTabs->addTab(sendZcoinView, tr("XFS"));
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    xfsnodeListPage->setClientModel(clientModel);
#ifdef ENABLE_ELYSIUM
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    xfsnodeListPage->setWalletModel(walletModel);
...
void WalletView::gotoXFSnodePage()
{
    setCurrentWidget(xfsnodeListPage);
}
