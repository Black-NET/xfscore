...
class CZMQXFSnodeListEvent : virtual public CZMQAbstractPublisher
{
    /* XFSnode List notification
    */
public:
    bool NotifyXFSnodeList();
};
...
class CZMQXFSnodeEvent : virtual public CZMQAbstractPublisher
{
    /* Data related to an updated XFSnode
    */
public:
    bool NotifyXFSnodeUpdate(CXFSnode &xfsnode);
};
...
class CZMQXFSnodeListTopic : public CZMQXFSnodeListEvent
{
public:
    void SetTopic(){ topic = "xfsnodeList";}
    void SetMethod(){ method= "xfsnodeList";}
};

class CZMQXFSnodeTopic : public CZMQXFSnodeEvent
{
public:
    void SetTopic(){ topic = "xfsnode";}
    void SetMethod(){ method= "xfsnodeUpdate";}
};
