 ...
 * [Xming](http://www.straightrunning.com/XmingNotes/) latest version, if you are planning to compile using [unix compiling instruction](https://github.com/xfs/Index/blob/master/doc/build-unix.md)
...
5. Clone git repository into newly created directory and go to the right branch
            ...
            git clone https://github.com/xfs/Index.git
            cd Index
...
8. After check the directory to run GUI with __xfs-qt.exe__
    
        C:\Users\<username>\index\src\qt
----
## Second method - Ubuntu + Xming
1. Use existing paper [build-unix](https://github.com/xfs/Index/blob/master/doc/build-unix.md) and
...
4. From Ubuntu bash window start xfs-qt:
