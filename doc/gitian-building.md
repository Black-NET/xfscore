...
*Setup instructions for a Gitian build of XFS Core using a Debian VM or physical system.*
...
- [Building XFS Core](#building-bitcoin-core)
...
To build XFS Core (for Linux, OS X and Windows) just follow the steps under 'perform
