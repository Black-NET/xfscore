...
XFS Core is now available at `./src/xfsd`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=bitcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/index/xfs.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/index/xfs.conf"

The first time you run xfsd, it will start downloading the blockchain. This process could take several hours.
...
-------
    ...
    ./src/xfsd -daemon # Starts the Index daemon.
    ./src/xfs-cli --help # Outputs a list of command-line options.
    ./src/xfs-cli help # Outputs a list of RPC commands when the daemon is running.
